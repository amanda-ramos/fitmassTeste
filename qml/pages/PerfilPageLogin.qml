...
import QtQuick 2.0
import VPlayApps 1.0 // this Plugin Example uses some Apps Components
...
/*/////////////////////////////////////
  ...
  Please follow the integration steps described in the plugin documentation: https://v-play.net/doc/plugin-firebase/
